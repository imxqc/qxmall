...
import com.cqx.common.to.MemberPrice;
import com.cqx.common.to.SkuReductionTo;
import com.cqx.common.utils.PageUtils;
import com.cqx.common.utils.Query;
import com.cqx.qxmall.coupon.dao.SkuFullReductionDao;
...
import com.cqx.qxmall.coupon.service.SkuFullReductionService;
...
public class SkuFullReductionServiceImpl extends ServiceImpl<SkuFullReductionDao, SkuFullReductionEntity> implements SkuFullReductionService {
    ...
    public void saveSkuReduction(SkuReductionTo reductionTo) {
        //1、// //5.4）、sku的优惠、满减等信息；qxmall_sms->sms_sku_ladder\sms_sku_full_reduction\sms_member_price
        //sms_sku_ladder
